...
- SHOULD prefer trustworthy stewardship (e.g., Apache Foundation, Linux Foundation,
  major vendors, or well-governed communities) over one-person side projects.
- SHOULD avoid adopting very new frameworks without evidence of long-term sustainability.
