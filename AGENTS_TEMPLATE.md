...
To switch modes later, use "ai-rules mode local" or "ai-rules mode git".
...
Git update note:
- Use `git subtree pull --prefix "<AI_RULES_PATH>" https://github.com/adaptable-inputs/ai-rules.git <REF> --squash`
