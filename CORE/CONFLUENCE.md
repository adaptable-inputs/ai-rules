...
- MUST NOT write/create/update Confluence wiki content unless explicitly asked by the user.
...
## Override Notes
- Project-specific Confluence workflows MAY add stricter controls, but the non-overridable no-delete rule,
  history-preservation rule, and explicit-write-only revertible-change policy remain mandatory.
